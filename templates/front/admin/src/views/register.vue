      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.chengshi" class="input" type="text" placeholder="城市">
			   </div>
			 </div> -->
			<el-form-item label="城市" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.chengshi" autocomplete="off" placeholder="城市"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
